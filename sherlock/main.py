...
async def diagnose(entity_id: str, body: DiagnoseRequest) -> StreamingResponse:
    ...
    # A resumed session already has real history — run it like any other
    # continuation. Only a genuinely fresh session checks Tier 2 memory for
    # a prior investigation to replay instead of running the full agent loop.
